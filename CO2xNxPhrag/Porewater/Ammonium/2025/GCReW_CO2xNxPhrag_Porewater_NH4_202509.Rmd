...
samples <- df_all %>%  
  ...
  filter(!str_detect(Sample_Name, c("PEchk"))) #have to do this because Phrag ids start with P 
...
samples <- df_all_cor %>%  
  ...
  filter(!str_detect(Sample_Name, c("PPT")))
  #have to do this because Phrag ids start with P    
