...
###### Run information - PLEASE CHANGE
  Date_Run = "2025-08-20"  #Date that instrument was run
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/CO2xNxPhrag_202407_Cl.txt"
  raw_file_name_so4 = "Raw Data/CO2xNxPhrag_202407_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/GCReW_CO2xNxPhrag_PW_Processed_Cl_SO4_202407.csv" 
...
viz_Cl_plot_v2 <- ggplot(
  ...
  labs(
    x = " ",
    y = "Cl (mM)",
    title = "CO2xNxPhrag: Porewater Cl",
    fill = "CO2 Treatment:",
    color = "N Treatment:",
    pattern = "Subplot:"
  ) +
