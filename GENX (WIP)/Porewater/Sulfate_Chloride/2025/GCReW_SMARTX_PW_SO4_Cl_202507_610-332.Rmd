...
author: "July 2025 Samples 610-332"
date: "`r Sys.Date()`"
output: 
  pdf_document:
    toc: true
...
###### Run information - PLEASE CHANGE
  Date_Run = "2025-12-30"  #Date that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  sample_year <- "2025"
  sample_month <- "July"
  Site = "GCREW"
  run_notes = "1/8 spks was high." #any notes from the run

###### File Names - PLEASE CHANGE 
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/SMARTX_202507_610-332_Cl.txt"
  raw_file_name_so4 = "Raw Data/SMARTX_202507_610-332_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/GCReW_SMARTX_PW_Processed_Cl_SO4_202507_610-332.csv" 
