...
#identify the files you want to read in 
  ...
  NH3_files <- c("Raw Data/Sept_2024_SMARTX_NH4_Run1.csv",
                 "Raw Data/Sept_2024_SMARTX_NH4_Run2.csv", 
                 "Raw Data/Sept_2024_SMARTX_NH4_Run3_rerun (with dilution).csv",
                 "Raw Data/Sept_2024_SMARTX_NH4_Run4.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_SMARTX_QAQC_Log_2024.csv"
  final_path <- "Processed Data/SMARTX_Porewater_NH4_202409.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "I think SMARTX_610-20 was input twice on the instrument and one is supposed to be4
      SMARTX_610-40 "
...
cols_to_remove <- c("RUNSTARTED", "X.2", "X.3", "X.4", "X.7")
...
df_NH3_dup <- df_all_cor %>%
  filter(Test == "Ammonia 2") %>%
  filter(
     !grepl("CCV|CCB|Blank|1mg/L ammonia|10ppt|Standard|Auto Spike|pe_chk", Sample_Name, ignore.case = TRUE), 
