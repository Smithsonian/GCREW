...
#identify the files you want to read in 
  ...
  NH3_files <- c("Raw Data/Sept_2024_Phrag_NH4_Run1.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_Phrag_QAQC_Log_2024.csv"
  final_path <- "Processed Data/Phrag_Porewater_NH4_202409.csv"
