...
NH3_forplot_C3 <- NH3_forplot_C3 %>%
  ...
  ungroup() %>%
  mutate(Treatment = ifelse(Temp_Treatment == 0, ifelse(CO2_Treatment == "Ambient", "T0", "eCT0"), ifelse(Temp_Treatment == 1.7, "T1", ifelse(Temp_Treatment == 3.4, "T2", ifelse(Temp_Treatment == 5.1, ifelse(CO2_Treatment == "Ambient", "T3", "eCT3"), NA)))))
...
viz_NH3_plot_C3 <- ggplot(data = NH3_forplot_C3, aes(
  ...
  scale_fill_manual(
    ...
    breaks = c("T0", "T1", "T2", "T3", "eCT0"),
    labels = c("aCO2","aCO2","aCO2","aCO2", "eCO2")
  ) +
  scale_color_manual(
    values = c(
      "T0" = "blue",
