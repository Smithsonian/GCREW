...
###### Run information - PLEASE CHANGE
  Date_Run = "2026-09-09"  #Date that instrument was run
  Run_by = "Victoria Ellis"  #Instrument user 
  Script_run_by = "Victoria Ellis" #Code user 
  sample_year <- "2026"
  sample_month <- "July"
  Site = "GCREW"
  run_notes = "Removed May re-run (Ch2-80) and added QAQC'd data to May processed file.
                  One bad duplicate." #any notes from the run

###### File Names - PLEASE CHANGE 
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/GENX_202607_Cl.txt"
  raw_file_name_so4 = "Raw Data/GENX_202607_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/GCReW_GENX_PW_Processed_Cl_SO4_202607.csv" 
