...
dat <- stds <- read_plate(
  file = "S:/GlobalChangeEco/porewater_r scripts & Data/Data/Sulfide Microplate/LTREB/2025 May Porewater/Tidy Data/20250527_LTREB_H2S_Plate2.csv",             # full path to the .csv file
...
#hash for first run
H2S_stds <- subset(H2S_stds, !(Wells %in% c("E01","E02","E03" )))
...
head(dat_IDs)
  write.csv(dat_IDs, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/LTREB/2025 May Porewater/QAQC'd Data/LTREB_H2S_20250527_H2S_Plate2_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/LTREB/2025 May Porewater/QAQC'd Data/LTREB_H2S_20250527_H2S_Plate2_Data.csv")
...
dat3 <- dat3[ ,-(2:5)]
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/LTREB/2025 May Porewater/QAQC'd data/LTREB_H2S_20250527_H2S_Plate2_short_Data.csv")
