...
Run_notes="Used STD curve from STD 2 07152025"
#packages:
library(ggplot2)
library(dplyr)
library(data.table)
...
file_path_raw = "S:/GlobalChangeEco/porewater_r scripts & Data/Data/Sulfide Microplate/LTREB/2025 July Porewater/Tidy Data/20250715_LTREB_H2S_Plate8.csv"
```
...
#hash for first run
H2S_stds <- subset(H2S_stds, !(Wells %in% c("E02")))
...
head(dat_IDs)
  write.csv(dat_IDs, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/LTREB/2025 July Porewater/QAQC'd Data/LTREB_H2S_20250715_Plate8_Summary_Data.csv")

#Read out all the data in dat 
head(dat)
write.csv(dat, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/LTREB/2025 July Porewater/QAQC'd Data/LTREB_H2S_20250715_Plate8_Data.csv")
...
dat3 <- dat3[ ,-(2:5)]
head(dat3)
write.csv(dat3, file="S:/GlobalChangeEco/Porewater_R scripts & Data/Data/Sulfide Microplate/LTREB/2025 July Porewater/QAQC'd data/LTREB_H2S_20250715_Plate8_short_Data.csv")
