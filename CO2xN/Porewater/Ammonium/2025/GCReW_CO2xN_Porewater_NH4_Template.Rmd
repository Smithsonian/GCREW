...
#identify the files you want to read in 
  ...
  NH3_files <- c("Raw Data/LTREB_July_2M_2025_Run1.csv",
                 "Raw Data/LTREB_July_2M_2025_Run2.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_CO2xN_QAQC_Log_2025.csv"
  final_path <- "Processed Data/CO2xN_Porewater_NH4_202507.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "pe_chk DUP out of range -- not sure why"
