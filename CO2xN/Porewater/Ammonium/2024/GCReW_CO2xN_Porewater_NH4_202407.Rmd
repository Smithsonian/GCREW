...
#identify the files you want to read in 
  ...
  NH3_files <- c("Raw Data/LTREB_2M_July_Run1.csv",
                 "Raw Data/LTREB_2M_July_Run2.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_CO2xN_QAQC_Log_2024.csv"
  final_path <- "Processed Data/CO2xN_Porewater_NH4_202407.csv"

#record any notes about the run or anything other info here: 
  run_notes <- "July and Sept data in Run2 - not sure whats up there"
