...
#identify the files you want to read in 
  ...
  NH3_files <- c("Raw Data/July_2024_CO2xCommunity_NH4.csv")

# Define the file path for QAQC log file - NO Need to change just check year 
  file_path <- "Raw Data/SEAL_CO2xComm_QAQC_Log_2024.csv"
  final_path <- "Processed Data/GCReW_CO2xCOMM_Porewater_NH4_202407.csv"
