---
title: "CO2xComm: Porewater SO4/Cl"
...
###### Run information - PLEASE CHANGE
  Date_Run = "2025-08-28"  #Date that instrument was run
  Run_by = "Zoe Read"  #Instrument user 
  Script_run_by = "Zoe Read" #Code user 
  sample_year <- "2024"
  sample_month <- "July"
  Site = "GCReW"
  Project_name = "CO2xCOMM"
  run_notes = "One spk had slightly high (124%) recovery.  
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/CO2xCOMM_202407_Cl.txt"
  raw_file_name_so4 = "Raw Data/CO2xCOMM_202407_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/GCReW_CO2xCOMM_PW_Processed_Cl_SO4_202407.csv" 
...
#need to work out how best to plot these data 
 ...
 SO4_forplot <- SO4_forplot[order(SO4_forplot$CO2_Treatment), ]
...
viz_SO4_plot_2 <- ggplot(data = SO4_forplot, aes(x = SO4_Conc_mM, y = as.numeric(Depth_cm), color = Plot_Color)) +
  ...
  labs(
    x = "SO4 (mM)",
    y = "Depth (cm)",
    title = "CO2xCOMM: Porewater SO4 by Replicate",
    color = "Replicate"
  ) +
...
#need to work out how best to plot these data 
 ...
 Cl_forplot <- Cl_forplot[order(Cl_forplot$CO2_Treatment), ]
...
viz_Cl_plot_2 <- ggplot(data = Cl_forplot, aes(x = Cl_Conc_mM, y = as.numeric(Depth_cm), color = Plot_Color)) +
  ...
  labs(
    x = "Cl (mM)",
    y = "Depth (cm)",
    title = "CO2xCOMM: Porewater Cl by Replicate",
    color = "Replicate"
  ) +
  scale_y_reverse(breaks = c(20, 40, 80), limits = c(90, 10)) +
  theme_classic() +
