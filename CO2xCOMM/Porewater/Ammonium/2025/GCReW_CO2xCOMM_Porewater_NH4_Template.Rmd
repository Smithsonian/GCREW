...
#Set up file path for metadata 
  ...
  Raw_Metadata = "Raw Data/Sample_IDs_LTREB_SMARTX_2025.csv"
...
viz_NH3_plot <- ggplot(data = NH3_forplot, aes(x = as.factor(CO2_Treatment), y = Conc, fill=as.factor(CO2_Treatment))) +
       geom_bar(stat = "identity", position = position_dodge2(preserve = "single"), 
                 color="black") + 
       facet_grid(Community~Depth, scales="free_x") +
        scale_fill_manual(values = c("Amb" = "turquoise4", 
                                     "Elev" = "maroon4")) +
        theme_classic() + 
        labs(x= " ", y="NH3 (mg/L)", title="CO2xCommunity: Porewater NH3", fill="CO2 Trtmt:") + 
...
df_all_clean_cols <- df_all_clean %>%
  select(Sample_Name, Sample_ID, Experiment, Plot_Name, Depth, CO2_Treatment, #N_Treatment, 
         Community,
         Year, Month,
...
final_data <- final_data_labeled %>%
  ...
  select(Site, Experiment, Month, Year, Sample_Name, Sample_ID,  
         Plot_Name, Depth, CO2_Treatment, 
         #N_Treatment,
         Community, 
