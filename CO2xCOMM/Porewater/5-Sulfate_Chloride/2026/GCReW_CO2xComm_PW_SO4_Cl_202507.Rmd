...
###### Run information - PLEASE CHANGE
  Date_Run = "2026-01-15"  #Date that instrument was run
...
#file path and name for raw summary data file 
  raw_file_name_cl = "Raw Data/CO2xCOMM_202507_Cl.txt"
  raw_file_name_so4 = "Raw Data/CO2xCOMM_202507_SO4.txt"

#file path and name of processed data file 
  processed_file_name = "Processed Data/GCReW_CO2xCOMM_PW_Processed_Cl_SO4_202507.csv" 
...
viz_cl_plot <- ggplot(data_plotting, aes(x = as.factor(Community), y = Cl_ppm, fill = as.factor(CO2_Treatment))) +
...
viz_so4_plot <-  ggplot(data_plotting, aes(x = as.factor(Community), y = SO4_ppm, fill = as.factor(CO2_Treatment))) +
  geom_bar(stat = "identity", position = position_dodge2(preserve = "single"), color="black") +   
  facet_grid(~ Depth_cm, labeller = labeller(Depth_cm = depth_labels), scales="free_x") +
  scale_fill_manual(values = c(
    "Elevated" = "red", 
